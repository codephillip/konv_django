# Generated by Django 3.2.3 on 2021-07-07 08:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('is_deleted', models.BooleanField(default=False)),
                ('type', models.CharField(blank=True, choices=[('ORDINARY', 'ORDINARY'), ('EXPRESS', 'EXPRESS')], max_length=30, null=True)),
                ('description', models.CharField(blank=True, max_length=255, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='app.location')),
            ],
            options={
                'db_table': 'order',
            },
